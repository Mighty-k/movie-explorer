    ...
    <div className="relative h-[80vh] w-full overflow-hidden rounded-b-3xl shadow-2xl">
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 z-20 p-12 w-full max-w-4xl">
            <motion.h1 
            ...
            >
              ...
              <span className="bg-white/10 backdrop-blur-md px-3 py-1 rounded-full text-sm font-medium">
            ...
            {currentMovie.overview && (
              <motion.p
                ...
                className="text-gray-300 text-lg mb-8 line-clamp-3 drop-shadow-lg"
              >
                {currentMovie.overview}
              </motion.p>
            )}
